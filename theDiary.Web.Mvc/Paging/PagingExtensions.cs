...
namespace System.Web.Mvc
{
	public static class PagingExtensions
	{
        ...
        public static Pager<TModel> Pager<TModel>(this HtmlHelper<TModel> htmlHelper, TModel model)
        {
            return htmlHelper.Pager<TModel>(((IPagedList)model).PageSize, ((IPagedList)model).PageNumber, ((IPagedList)model).TotalItemCount);
        }
        ...
        {
            int pageSize;
            if (!int.TryParse(System.Configuration.ConfigurationManager.AppSettings["pager:ItemsPerPage"], out pageSize))
                pageSize = 20;
