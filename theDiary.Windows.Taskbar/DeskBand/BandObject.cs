...
namespace Seth.Windows.Taskbar.DeskBand
{
    ...
    public class BandObject 
        : UserControl, IObjectWithSite, IDeskBand, IDockingWindow, IOleWindow, IInputObject
    {
        /// <summary>
        /// Reference to the host explorer.
        /// </summary>
        protected IWebBrowser2 Explorer;
            ...
            ref DeskBankInfo dbi)
        {
            ...
            dbi.dwModeFlags = DeskBankInfoMessage.TITLE | DeskBankInfoMessage.ACTUAL | DeskBankInfoMessage.MAXSIZE | DeskBankInfoMessage.MINSIZE | DeskBankInfoMessage.INTEGRAL;
        }
